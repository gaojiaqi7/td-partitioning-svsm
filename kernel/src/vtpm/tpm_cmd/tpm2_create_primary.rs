...
pub fn create_primary(handle: u32, public_area: &[u8]) -> Result<Tpm2CreatePrimary, SvsmError> {
...
pub fn tpm2_command_create_primary(handle: u32, public_area: &[u8]) -> Result<Vec<u8>, SvsmError> {
...
fn tpm2_response_create_primary(response: &[u8]) -> Result<Tpm2CreatePrimary, SvsmError> {
