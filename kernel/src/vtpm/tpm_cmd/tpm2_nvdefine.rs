...
extern crate alloc;
use super::*;
use crate::vtpm::MsTpmSimulatorInterface;
use crate::{
    error::SvsmError,
    vtpm::{vtpm_get_locked, TpmError},
};
use alloc::{vec, vec::Vec};
use tpm2_digests::TPM2_HASH_ALG_ID_SHA384;

const TPM2_CC_NV_DEFINE_SPACE: u32 = 0x0000012A;

pub fn nv_define_space(nv_index: u32, nv_size: u16, nv_attributes: u32) -> Result<(), SvsmError> {
...
fn tpm2_response_nv_define_space(response: &[u8]) -> Result<(), SvsmError> {
